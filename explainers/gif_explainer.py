...
class gif_explainer():
    def __init__(self, model, labels):
        ...
        self.ae = xrv.autoencoders.ResNetAE(weights=None).cuda()
        path = "/mnt/qb/work/baumgartner/sun22/project/torchxrayvision_autoencoder.ResNetAE/nihpcrsnamimic_ch-resnet101-2-ae-test2-elastic-e250.pt"
